...
class AddMachineParams(Type):
    ...
    def __init__(self, addresses=None, base=None, constraints=None, container_type=None, disks=None, hardware_characteristics=None, instance_id=None, jobs=None, nonce=None, parent_id=None, placement=None, **unknown_fields):
        ...
        constraints : Value
        container_type : str
        disks : typing.Sequence[~Directive]
        ...
        disks_ = [Directive.from_json(o) for o in disks or []]
...
class ApplicationDeploy(Type):
    ...
    def __init__(self, force=None, application=None, attach_storage=None, channel=None, charm_origin=None, charm_url=None, config=None, config_yaml=None, constraints=None, devices=None, endpoint_bindings=None, num_units=None, placement=None, policy=None, resources=None, storage=None, **unknown_fields):
        ...
        storage : typing.Mapping[str, ~Directive]
        '''
        force_ = force
        application_ = application
        attach_storage_ = attach_storage
        ...
        storage_ = {k: Directive.from_json(v) for k, v in (storage or dict()).items()}
...
class ApplicationSetCharmV2(Type):
    _toSchema = {'application': 'application', 'channel': 'channel', 'charm_origin': 'charm-origin', 'charm_url': 'charm-url', 'config_settings': 'config-settings', 'config_settings_yaml': 'config-settings-yaml', 'endpoint_bindings': 'endpoint-bindings', 'force': 'force', 'force_base': 'force-base', 'force_units': 'force-units', 'generation': 'generation', 'resource_ids': 'resource-ids', 'storage_directives': 'storage-directives'}
    _toPy = {'application': 'application', 'channel': 'channel', 'charm-origin': 'charm_origin', 'charm-url': 'charm_url', 'config-settings': 'config_settings', 'config-settings-yaml': 'config_settings_yaml', 'endpoint-bindings': 'endpoint_bindings', 'force': 'force', 'force-base': 'force_base', 'force-units': 'force_units', 'generation': 'generation', 'resource-ids': 'resource_ids', 'storage-directives': 'storage_directives'}
    def __init__(self, application=None, channel=None, charm_origin=None, charm_url=None, config_settings=None, config_settings_yaml=None, endpoint_bindings=None, force=None, force_base=None, force_units=None, generation=None, resource_ids=None, storage_directives=None, **unknown_fields):
        '''
        application : str
        channel : str
        charm_origin : CharmOrigin
        ...
        storage_directives_ = {k: StorageDirectives.from_json(v) for k, v in (storage_directives or dict()).items()}
        ...
        if storage_directives_ is not None and not isinstance(storage_directives_, dict):
            raise Exception("Expected storage_directives_ to be a Mapping, received: {}".format(type(storage_directives_)))
        ...
        self.storage_directives = storage_directives_
        self.unknown_fields = unknown_fields



class ApplicationStatus(Type):
    _toSchema = {'base': 'base', 'can_upgrade_to': 'can-upgrade-to', 'charm': 'charm', 'charm_channel': 'charm-channel', 'charm_profile': 'charm-profile', 'charm_rev': 'charm-rev', 'charm_version': 'charm-version', 'endpoint_bindings': 'endpoint-bindings', 'err': 'err', 'exposed': 'exposed', 'exposed_endpoints': 'exposed-endpoints', 'int_': 'int', 'life': 'life', 'provider_id': 'provider-id', 'public_address': 'public-address', 'relations': 'relations', 'status': 'status', 'subordinate_to': 'subordinate-to', 'units': 'units', 'workload_version': 'workload-version'}
    _toPy = {'base': 'base', 'can-upgrade-to': 'can_upgrade_to', 'charm': 'charm', 'charm-channel': 'charm_channel', 'charm-profile': 'charm_profile', 'charm-rev': 'charm_rev', 'charm-version': 'charm_version', 'endpoint-bindings': 'endpoint_bindings', 'err': 'err', 'exposed': 'exposed', 'exposed-endpoints': 'exposed_endpoints', 'int': 'int_', 'life': 'life', 'provider-id': 'provider_id', 'public-address': 'public_address', 'relations': 'relations', 'status': 'status', 'subordinate-to': 'subordinate_to', 'units': 'units', 'workload-version': 'workload_version'}
    def __init__(self, base=None, can_upgrade_to=None, charm=None, charm_channel=None, charm_profile=None, charm_rev=None, charm_version=None, endpoint_bindings=None, err=None, exposed=None, exposed_endpoints=None, int_=None, life=None, provider_id=None, public_address=None, relations=None, status=None, subordinate_to=None, units=None, workload_version=None, **unknown_fields):
        '''
        base : Base
        can_upgrade_to : str
        charm : str
        ...
        if charm_rev_ is not None and not isinstance(charm_rev_, int):
            raise Exception("Expected charm_rev_ to be a int, received: {}".format(type(charm_rev_)))
...
class ApplicationStorageGetResult(Type):
    _toSchema = {'error': 'Error', 'storage_constraints': 'storage-constraints'}
    _toPy = {'Error': 'error', 'storage-constraints': 'storage_constraints'}
    def __init__(self, error=None, storage_constraints=None, **unknown_fields):
        '''
        error : Error
        storage_constraints : typing.Mapping[str, ~StorageDirectives]
        '''
        error_ = Error.from_json(error) if error else None
        storage_constraints_ = {k: StorageDirectives.from_json(v) for k, v in (storage_constraints or dict()).items()}
...
class ApplicationStorageGetResults(Type):
    _toSchema = {'results': 'results'}
    _toPy = {'results': 'results'}
    def __init__(self, results=None, **unknown_fields):
        '''
        results : typing.Sequence[~ApplicationStorageGetResult]
        '''
        results_ = [ApplicationStorageGetResult.from_json(o) for o in results or []]
...
class ApplicationStorageUpdate(Type):
    _toSchema = {'application_tag': 'application-tag', 'storage_constraints': 'storage-constraints'}
    _toPy = {'application-tag': 'application_tag', 'storage-constraints': 'storage_constraints'}
    def __init__(self, application_tag=None, storage_constraints=None, **unknown_fields):
        '''
        application_tag : str
        storage_constraints : typing.Mapping[str, ~StorageDirectives]
        '''
...
class ApplicationStorageUpdateRequest(Type):
    _toSchema = {'storage_updates': 'storage-updates'}
    _toPy = {'storage-updates': 'storage_updates'}
    def __init__(self, storage_updates=None, **unknown_fields):
        '''
        storage_updates : typing.Sequence[~ApplicationStorageUpdate]
        '''
        storage_updates_ = [ApplicationStorageUpdate.from_json(o) for o in storage_updates or []]

        # Validate arguments against known Juju API types.
        if storage_updates_ is not None and not isinstance(storage_updates_, (bytes, str, list)):
            raise Exception("Expected storage_updates_ to be a Sequence, received: {}".format(type(storage_updates_)))

        self.storage_updates = storage_updates_
        self.unknown_fields = unknown_fields
...
class BulkImportStorageParamsV2(Type):
    ...
    def __init__(self, storage=None, **unknown_fields):
        ...
        '''
        storage_ = [ImportStorageParamsV2.from_json(o) for o in storage or []]
...
class Charm(Type):
    _toSchema = {'actions': 'actions', 'config': 'config', 'lxd_profile': 'lxd-profile', 'manifest': 'manifest', 'meta': 'meta', 'revision': 'revision', 'url': 'url', 'version': 'version'}
    _toPy = {'actions': 'actions', 'config': 'config', 'lxd-profile': 'lxd_profile', 'manifest': 'manifest', 'meta': 'meta', 'revision': 'revision', 'url': 'url', 'version': 'version'}
    def __init__(self, actions=None, config=None, lxd_profile=None, manifest=None, meta=None, revision=None, url=None, version=None, **unknown_fields):
        '''
...
class CharmActionSpec(Type):
    _toSchema = {'description': 'description', 'execution_group': 'execution-group', 'parallel': 'parallel', 'params': 'params'}
    _toPy = {'description': 'description', 'execution-group': 'execution_group', 'parallel': 'parallel', 'params': 'params'}
    def __init__(self, description=None, execution_group=None, parallel=None, params=None, **unknown_fields):
        '''
        description : str
        execution_group : str
        parallel : bool
...
class CharmMeta(Type):
    _toSchema = {'assumes_expr': 'assumes-expr', 'categories': 'categories', 'charm_user': 'charm-user', 'containers': 'containers', 'description': 'description', 'devices': 'devices', 'extra_bindings': 'extra-bindings', 'min_juju_version': 'min-juju-version', 'name': 'name', 'peers': 'peers', 'provides': 'provides', 'requires': 'requires', 'resources': 'resources', 'storage': 'storage', 'subordinate': 'subordinate', 'summary': 'summary', 'tags': 'tags', 'terms': 'terms'}
    _toPy = {'assumes-expr': 'assumes_expr', 'categories': 'categories', 'charm-user': 'charm_user', 'containers': 'containers', 'description': 'description', 'devices': 'devices', 'extra-bindings': 'extra_bindings', 'min-juju-version': 'min_juju_version', 'name': 'name', 'peers': 'peers', 'provides': 'provides', 'requires': 'requires', 'resources': 'resources', 'storage': 'storage', 'subordinate': 'subordinate', 'summary': 'summary', 'tags': 'tags', 'terms': 'terms'}
    def __init__(self, assumes_expr=None, categories=None, charm_user=None, containers=None, description=None, devices=None, extra_bindings=None, min_juju_version=None, name=None, peers=None, provides=None, requires=None, resources=None, storage=None, subordinate=None, summary=None, tags=None, terms=None, **unknown_fields):
        '''
...
class ControllerDetails(Type):
    _toSchema = {'api_addresses': 'api-addresses', 'controller_id': 'controller-id', 'error': 'error'}
    _toPy = {'api-addresses': 'api_addresses', 'controller-id': 'controller_id', 'error': 'error'}
    def __init__(self, api_addresses=None, controller_id=None, error=None, **unknown_fields):
        '''
        ...
        if controller_id_ is not None and not isinstance(controller_id_, (bytes, str)):
            raise Exception("Expected controller_id_ to be a str, received: {}".format(type(controller_id_)))
...
class ControllerDetailsResults(Type):
    _toSchema = {'results': 'results'}
    _toPy = {'results': 'results'}
    def __init__(self, results=None, **unknown_fields):
        '''
        results : typing.Sequence[~ControllerDetails]
        '''
        results_ = [ControllerDetails.from_json(o) for o in results or []]
...
class DeployFromRepositoryArg(Type):
    ...
    _toPy = {'ApplicationName': 'applicationname', 'AttachStorage': 'attachstorage', 'CharmName': 'charmname', 'ConfigYAML': 'configyaml', 'Cons': 'cons', 'Devices': 'devices', 'DryRun': 'dryrun', 'Placement': 'placement', 'Trust': 'trust', 'base': 'base', 'channel': 'channel', 'endpoint-bindings': 'endpoint_bindings', 'force': 'force', 'num-units': 'num_units', 'resources': 'resources', 'revision': 'revision', 'storage': 'storage'}
    def __init__(self, applicationname=None, attachstorage=None, charmname=None, configyaml=None, cons=None, devices=None, dryrun=None, placement=None, trust=None, base=None, channel=None, endpoint_bindings=None, force=None, num_units=None, resources=None, revision=None, storage=None, **unknown_fields):
        '''
        applicationname : str
...
class HostedModelConfig(Type):
    _toSchema = {'cloud_spec': 'cloud-spec', 'config': 'config', 'error': 'error', 'name': 'name', 'qualifier': 'qualifier'}
    _toPy = {'cloud-spec': 'cloud_spec', 'config': 'config', 'error': 'error', 'name': 'name', 'qualifier': 'qualifier'}
    def __init__(self, cloud_spec=None, config=None, error=None, name=None, qualifier=None, **unknown_fields):
        '''
        ...
        if qualifier_ is not None and not isinstance(qualifier_, (bytes, str)):
            raise Exception("Expected qualifier_ to be a str, received: {}".format(type(qualifier_)))
...
class ImportStorageParamsV2(Type):
    _toSchema = {'force': 'force', 'kind': 'kind', 'pool': 'pool', 'provider_id': 'provider-id', 'storage_name': 'storage-name'}
    _toPy = {'force': 'force', 'kind': 'kind', 'pool': 'pool', 'provider-id': 'provider_id', 'storage-name': 'storage_name'}
    def __init__(self, force=None, kind=None, pool=None, provider_id=None, storage_name=None, **unknown_fields):
        '''
        force : bool
        kind : int
        pool : str
...
class ListSecretResult(Type):
    ...
    _toPy = {'access': 'access', 'create-time': 'create_time', 'description': 'description', 'label': 'label', 'latest-expire-time': 'latest_expire_time', 'latest-revision': 'latest_revision', 'latest-revision-checksum': 'latest_revision_checksum', 'next-rotate-time': 'next_rotate_time', 'owner-tag': 'owner_tag', 'revisions': 'revisions', 'rotate-policy': 'rotate_policy', 'update-time': 'update_time', 'uri': 'uri', 'value': 'value', 'version': 'version'}
    def __init__(self, access=None, create_time=None, description=None, label=None, latest_expire_time=None, latest_revision=None, latest_revision_checksum=None, next_rotate_time=None, owner_tag=None, revisions=None, rotate_policy=None, update_time=None, uri=None, value=None, version=None, **unknown_fields):
        '''
        ...
        if latest_revision_checksum_ is not None and not isinstance(latest_revision_checksum_, (bytes, str)):
            raise Exception("Expected latest_revision_checksum_ to be a str, received: {}".format(type(latest_revision_checksum_)))
...
class MachineStatus(Type):
    ...
    def __init__(self, agent_status=None, base=None, cluster_role=None, constraints=None, containers=None, display_name=None, dns_name=None, hardware=None, has_vote=None, hostname=None, id_=None, instance_id=None, instance_status=None, ip_addresses=None, jobs=None, lxd_profiles=None, modification_status=None, network_interfaces=None, primary_controller_machine=None, wants_vote=None, **unknown_fields):
        ...
        if cluster_role_ is not None and not isinstance(cluster_role_, (bytes, str)):
            raise Exception("Expected cluster_role_ to be a str, received: {}".format(type(cluster_role_)))
        ...
        self.base = base_
        self.cluster_role = cluster_role_
        self.constraints = constraints_
        self.containers = containers_
        self.display_name = display_name_
...
class MigrationTargetInfo(Type):
    _toSchema = {'addrs': 'addrs', 'auth_tag': 'auth-tag', 'ca_cert': 'ca-cert', 'controller_alias': 'controller-alias', 'controller_tag': 'controller-tag', 'macaroons': 'macaroons', 'password': 'password', 'skip_user_checks': 'skip-user-checks', 'token': 'token'}
    _toPy = {'addrs': 'addrs', 'auth-tag': 'auth_tag', 'ca-cert': 'ca_cert', 'controller-alias': 'controller_alias', 'controller-tag': 'controller_tag', 'macaroons': 'macaroons', 'password': 'password', 'skip-user-checks': 'skip_user_checks', 'token': 'token'}
    def __init__(self, addrs=None, auth_tag=None, ca_cert=None, controller_alias=None, controller_tag=None, macaroons=None, password=None, skip_user_checks=None, token=None, **unknown_fields):
        '''
        addrs : typing.Sequence[str]
        auth_tag : str
        ca_cert : str
        ...
        password_ = password
        skip_user_checks_ = skip_user_checks
        token_ = token
        ...
        if skip_user_checks_ is not None and not isinstance(skip_user_checks_, bool):
            raise Exception("Expected skip_user_checks_ to be a bool, received: {}".format(type(skip_user_checks_)))
        ...
        self.macaroons = macaroons_
        self.password = password_
        self.skip_user_checks = skip_user_checks_
        self.token = token_
        self.unknown_fields = unknown_fields
...
class Model(Type):
    _toSchema = {'name': 'name', 'qualifier': 'qualifier', 'type_': 'type', 'uuid': 'uuid'}
    _toPy = {'name': 'name', 'qualifier': 'qualifier', 'type': 'type_', 'uuid': 'uuid'}
    def __init__(self, name=None, qualifier=None, type_=None, uuid=None, **unknown_fields):
        '''
        name : str
        qualifier : str
        type_ : str
...
class ModelBlockInfo(Type):
    _toSchema = {'blocks': 'blocks', 'model_uuid': 'model-uuid', 'name': 'name', 'qualifier': 'qualifier'}
    _toPy = {'blocks': 'blocks', 'model-uuid': 'model_uuid', 'name': 'name', 'qualifier': 'qualifier'}
    def __init__(self, blocks=None, model_uuid=None, name=None, qualifier=None, **unknown_fields):
        '''
...
class ModelCreateArgs(Type):
    _toSchema = {'cloud_tag': 'cloud-tag', 'config': 'config', 'credential': 'credential', 'name': 'name', 'qualifier': 'qualifier', 'region': 'region', 'target_controller': 'target-controller'}
    _toPy = {'cloud-tag': 'cloud_tag', 'config': 'config', 'credential': 'credential', 'name': 'name', 'qualifier': 'qualifier', 'region': 'region', 'target-controller': 'target_controller'}
    def __init__(self, cloud_tag=None, config=None, credential=None, name=None, qualifier=None, region=None, target_controller=None, **unknown_fields):
        '''
        cloud_tag : str
        config : typing.Mapping[str, typing.Any]
        credential : str
        ...
        if target_controller_ is not None and not isinstance(target_controller_, (bytes, str)):
            raise Exception("Expected target_controller_ to be a str, received: {}".format(type(target_controller_)))
        ...
        self.qualifier = qualifier_
        self.region = region_
        self.target_controller = target_controller_
        self.unknown_fields = unknown_fields
...
class ModelInfo(Type):
    _toSchema = {'agent_version': 'agent-version', 'cloud_credential_tag': 'cloud-credential-tag', 'cloud_credential_validity': 'cloud-credential-validity', 'cloud_region': 'cloud-region', 'cloud_tag': 'cloud-tag', 'controller_uuid': 'controller-uuid', 'is_controller': 'is-controller', 'life': 'life', 'machines': 'machines', 'migration': 'migration', 'name': 'name', 'provider_type': 'provider-type', 'qualifier': 'qualifier', 'secret_backends': 'secret-backends', 'status': 'status', 'supported_features': 'supported-features', 'target_controller': 'target-controller', 'type_': 'type', 'users': 'users', 'uuid': 'uuid'}
    _toPy = {'agent-version': 'agent_version', 'cloud-credential-tag': 'cloud_credential_tag', 'cloud-credential-validity': 'cloud_credential_validity', 'cloud-region': 'cloud_region', 'cloud-tag': 'cloud_tag', 'controller-uuid': 'controller_uuid', 'is-controller': 'is_controller', 'life': 'life', 'machines': 'machines', 'migration': 'migration', 'name': 'name', 'provider-type': 'provider_type', 'qualifier': 'qualifier', 'secret-backends': 'secret_backends', 'status': 'status', 'supported-features': 'supported_features', 'target-controller': 'target_controller', 'type': 'type_', 'users': 'users', 'uuid': 'uuid'}
    def __init__(self, agent_version=None, cloud_credential_tag=None, cloud_credential_validity=None, cloud_region=None, cloud_tag=None, controller_uuid=None, is_controller=None, life=None, machines=None, migration=None, name=None, provider_type=None, qualifier=None, secret_backends=None, status=None, supported_features=None, target_controller=None, type_=None, users=None, uuid=None, **unknown_fields):
        '''
...
class ModelMachineInfo(Type):
    _toSchema = {'display_name': 'display-name', 'hardware': 'hardware', 'id_': 'id', 'instance_id': 'instance-id', 'message': 'message', 'status': 'status'}
    _toPy = {'display-name': 'display_name', 'hardware': 'hardware', 'id': 'id_', 'instance-id': 'instance_id', 'message': 'message', 'status': 'status'}
    def __init__(self, display_name=None, hardware=None, id_=None, instance_id=None, message=None, status=None, **unknown_fields):
        '''
        display_name : str
...
class ModelStatus(Type):
    _toSchema = {'application_count': 'application-count', 'applications': 'applications', 'error': 'error', 'filesystems': 'filesystems', 'hosted_machine_count': 'hosted-machine-count', 'life': 'life', 'machines': 'machines', 'model_tag': 'model-tag', 'qualifier': 'qualifier', 'type_': 'type', 'unit_count': 'unit-count', 'volumes': 'volumes'}
    _toPy = {'application-count': 'application_count', 'applications': 'applications', 'error': 'error', 'filesystems': 'filesystems', 'hosted-machine-count': 'hosted_machine_count', 'life': 'life', 'machines': 'machines', 'model-tag': 'model_tag', 'qualifier': 'qualifier', 'type': 'type_', 'unit-count': 'unit_count', 'volumes': 'volumes'}
    def __init__(self, application_count=None, applications=None, error=None, filesystems=None, hosted_machine_count=None, life=None, machines=None, model_tag=None, qualifier=None, type_=None, unit_count=None, volumes=None, **unknown_fields):
        '''
...
class ModelStatusInfo(Type):
    _toSchema = {'available_version': 'available-version', 'cloud_tag': 'cloud-tag', 'model_status': 'model-status', 'name': 'name', 'region': 'region', 'type_': 'type', 'version': 'version'}
    _toPy = {'available-version': 'available_version', 'cloud-tag': 'cloud_tag', 'model-status': 'model_status', 'name': 'name', 'region': 'region', 'type': 'type_', 'version': 'version'}
    def __init__(self, available_version=None, cloud_tag=None, model_status=None, name=None, region=None, type_=None, version=None, **unknown_fields):
        '''
...
class ModelSummary(Type):
    _toSchema = {'agent_version': 'agent-version', 'cloud_credential_tag': 'cloud-credential-tag', 'cloud_region': 'cloud-region', 'cloud_tag': 'cloud-tag', 'controller_uuid': 'controller-uuid', 'counts': 'counts', 'is_controller': 'is-controller', 'last_connection': 'last-connection', 'life': 'life', 'migration': 'migration', 'name': 'name', 'provider_type': 'provider-type', 'qualifier': 'qualifier', 'status': 'status', 'type_': 'type', 'user_access': 'user-access', 'uuid': 'uuid'}
    _toPy = {'agent-version': 'agent_version', 'cloud-credential-tag': 'cloud_credential_tag', 'cloud-region': 'cloud_region', 'cloud-tag': 'cloud_tag', 'controller-uuid': 'controller_uuid', 'counts': 'counts', 'is-controller': 'is_controller', 'last-connection': 'last_connection', 'life': 'life', 'migration': 'migration', 'name': 'name', 'provider-type': 'provider_type', 'qualifier': 'qualifier', 'status': 'status', 'type': 'type_', 'user-access': 'user_access', 'uuid': 'uuid'}
    def __init__(self, agent_version=None, cloud_credential_tag=None, cloud_region=None, cloud_tag=None, controller_uuid=None, counts=None, is_controller=None, last_connection=None, life=None, migration=None, name=None, provider_type=None, qualifier=None, status=None, type_=None, user_access=None, uuid=None, **unknown_fields):
        '''
        agent_version : Number
        cloud_credential_tag : str
        cloud_region : str
...
class OfferFilter(Type):
    _toSchema = {'allowed_users': 'allowed-users', 'application_description': 'application-description', 'application_name': 'application-name', 'application_user': 'application-user', 'connected_users': 'connected-users', 'endpoints': 'endpoints', 'model_name': 'model-name', 'model_qualifier': 'model-qualifier', 'offer_name': 'offer-name'}
    _toPy = {'allowed-users': 'allowed_users', 'application-description': 'application_description', 'application-name': 'application_name', 'application-user': 'application_user', 'connected-users': 'connected_users', 'endpoints': 'endpoints', 'model-name': 'model_name', 'model-qualifier': 'model_qualifier', 'offer-name': 'offer_name'}
    def __init__(self, allowed_users=None, application_description=None, application_name=None, application_user=None, connected_users=None, endpoints=None, model_name=None, model_qualifier=None, offer_name=None, **unknown_fields):
        '''
        ...
        model_qualifier_ = model_qualifier
        offer_name_ = offer_name
        ...
        if model_qualifier_ is not None and not isinstance(model_qualifier_, (bytes, str)):
            raise Exception("Expected model_qualifier_ to be a str, received: {}".format(type(model_qualifier_)))
        ...
        self.model_qualifier = model_qualifier_
        self.offer_name = offer_name_
        self.unknown_fields = unknown_fields
...
class RunParams(Type):
    _toSchema = {'applications': 'applications', 'commands': 'commands', 'execution_group': 'execution-group', 'machines': 'machines', 'parallel': 'parallel', 'timeout': 'timeout', 'units': 'units'}
    _toPy = {'applications': 'applications', 'commands': 'commands', 'execution-group': 'execution_group', 'machines': 'machines', 'parallel': 'parallel', 'timeout': 'timeout', 'units': 'units'}
    def __init__(self, applications=None, commands=None, execution_group=None, machines=None, parallel=None, timeout=None, units=None, **unknown_fields):
        '''
        applications : typing.Sequence[str]
        commands : str
        execution_group : str
...
class ScaleApplicationParamsV2(Type):
    _toSchema = {'application_tag': 'application-tag', 'attach_storage': 'attach-storage', 'force': 'force', 'scale': 'scale', 'scale_change': 'scale-change'}
    _toPy = {'application-tag': 'application_tag', 'attach-storage': 'attach_storage', 'force': 'force', 'scale': 'scale', 'scale-change': 'scale_change'}
    def __init__(self, application_tag=None, attach_storage=None, force=None, scale=None, scale_change=None, **unknown_fields):
        '''
        application_tag : str
        attach_storage : typing.Sequence[str]
        force : bool
...
class ScaleApplicationsParamsV2(Type):
    _toSchema = {'applications': 'applications'}
    _toPy = {'applications': 'applications'}
    def __init__(self, applications=None, **unknown_fields):
        '''
        ...
        '''
        applications_ = [ScaleApplicationParamsV2.from_json(o) for o in applications or []]
...
class SetModelSecretBackendArg(Type):
    _toSchema = {'secret_backend_name': 'secret-backend-name'}
    _toPy = {'secret-backend-name': 'secret_backend_name'}
    def __init__(self, secret_backend_name=None, **unknown_fields):
        '''
        secret_backend_name : str
        '''
        secret_backend_name_ = secret_backend_name

        # Validate arguments against known Juju API types.
        if secret_backend_name_ is not None and not isinstance(secret_backend_name_, (bytes, str)):
            raise Exception("Expected secret_backend_name_ to be a str, received: {}".format(type(secret_backend_name_)))

        self.secret_backend_name = secret_backend_name_
        self.unknown_fields = unknown_fields
...
class StorageAddParams(Type):
    ...
    def __init__(self, name=None, storage=None, unit=None, **unknown_fields):
        ...
        '''
        name_ = name
        storage_ = StorageDirectives.from_json(storage) if storage else None
        unit_ = unit
        ...
        if storage_ is not None and not isinstance(storage_, (dict, StorageDirectives)):
            raise Exception("Expected storage_ to be a StorageDirectives, received: {}".format(type(storage_)))
...
class Subnet(Type):
    _toSchema = {'cidr': 'cidr', 'life': 'life', 'provider_id': 'provider-id', 'provider_network_id': 'provider-network-id', 'provider_space_id': 'provider-space-id', 'space_tag': 'space-tag', 'vlan_tag': 'vlan-tag', 'zones': 'zones'}
    _toPy = {'cidr': 'cidr', 'life': 'life', 'provider-id': 'provider_id', 'provider-network-id': 'provider_network_id', 'provider-space-id': 'provider_space_id', 'space-tag': 'space_tag', 'vlan-tag': 'vlan_tag', 'zones': 'zones'}
    def __init__(self, cidr=None, life=None, provider_id=None, provider_network_id=None, provider_space_id=None, space_tag=None, vlan_tag=None, zones=None, **unknown_fields):
        '''
        cidr : str
        life : str
        provider_id : str
...
class SubnetV2(Type):
    _toSchema = {'cidr': 'cidr', 'id_': 'id', 'life': 'life', 'provider_id': 'provider-id', 'provider_network_id': 'provider-network-id', 'provider_space_id': 'provider-space-id', 'space_tag': 'space-tag', 'subnet': 'Subnet', 'vlan_tag': 'vlan-tag', 'zones': 'zones'}
    _toPy = {'Subnet': 'subnet', 'cidr': 'cidr', 'id': 'id_', 'life': 'life', 'provider-id': 'provider_id', 'provider-network-id': 'provider_network_id', 'provider-space-id': 'provider_space_id', 'space-tag': 'space_tag', 'vlan-tag': 'vlan_tag', 'zones': 'zones'}
    def __init__(self, subnet=None, cidr=None, id_=None, life=None, provider_id=None, provider_network_id=None, provider_space_id=None, space_tag=None, vlan_tag=None, zones=None, **unknown_fields):
        '''
        subnet : Subnet
        cidr : str
        id_ : str
...
class VirtualHostnameTargetArg(Type):
    _toSchema = {'container': 'container', 'tag': 'tag'}
    _toPy = {'container': 'container', 'tag': 'tag'}
    def __init__(self, container=None, tag=None, **unknown_fields):
        '''
        container : str
        tag : str
        '''
